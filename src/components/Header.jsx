...
const Header = () => {
  const [searchQuery, setSearchQuery] = useState("");  // we created a state
  ...
  //in line 39 i have changes scss
  return (
    <div className="sticky top-0 z-10 flex flex-row  items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <img
            className="h-full hidden md:block dark:visible"   // i have changed scss here
            src={ytLogo}
            alt="Youtube"
          />
          <img
